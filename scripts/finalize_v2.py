...
anchor = '''    assert result.exported_file.path.exists()


def test_naive_datetime_is_rejected():
'''
addition = '''    assert result.exported_file.path.exists()
...
def test_naive_datetime_is_rejected():
'''
if 'test_empty_portfolio_history_has_explicit_reason' not in tests:
